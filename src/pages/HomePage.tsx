...
function Hero() {
  return (
    <section className="relative isolate overflow-hidden">
      <div className="absolute inset-0 -z-10 h-[100vh] md:h-[120vh]">
      ...
      <div className="container-prose flex min-h-[88vh] flex-col items-start justify-center gap-6 py-16 sm:gap-8 sm:py-20">
        <motion.div
        ...
        <AnimatedHeading
          ...
          className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-medium text-shimmer"
        />
        ...
        <motion.p
          ...
          className="max-w-2xl text-base leading-relaxed text-parchment-100/80 sm:text-lg md:text-xl"
        >
        ...
        >
          <Link to="/hall" className="btn-primary w-full justify-center sm:w-auto">
            Войти в музей
            <span aria-hidden>→</span>
          </Link>
          <Link to="/about" className="btn-ghost w-full justify-center sm:w-auto">
            О проекте
          </Link>
        </motion.div>
...
function Preview() {
  return (
    <section className="container-prose py-10 md:py-24">
      <div className="mb-8 max-w-2xl md:mb-12">
        <div className="chip mb-4">Анонс трёх экскурсий</div>
        <h2 className="heading-serif text-3xl text-parchment-50 sm:text-4xl md:text-5xl">
        ...
        {excursions.map((e, i) => (
          ...
          >
            ...
            >
              ...
              <h3 className="mt-4 heading-serif text-2xl text-parchment-50 sm:text-3xl">{e.title}</h3>
